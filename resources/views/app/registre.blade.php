...
@section('content')
<form class="container form-group my-4">
    <h1 class="my-4">Registre sua bike</h1>
    <h2 class="my-4">
        Dados do comprador
    </h2>
    <input class="form-control my-2" type="name" placeholder="Informe seu nome:">
    <input class="form-control my-2" type="email" placeholder="Seu email:">
    <input class="form-control my-2" type="telephone" placeholder="Telefone:">
    ...
    <input class="form-control my-2" type="telephone" placeholder="Rua:">
    <div class="my-2 row">
    ...
    <div class="my-2 row">
        ...
        <div class="col-md-5 mx-0 my-2">
            <input type=" text" class="form-control" placeholder="Número de Série do Quadro">
        </div>
        <div class="col-md-5 mx-0 my-2">
    ...
    <div class="form-check my-4">
        <input class="form-check-input" type="radio" required name="exampleRadios" id="exampleRadios1" value="option1">
