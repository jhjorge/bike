...
@section('content')
    <form action="" method="post" class="container form-group my-4">
        <h1 class="my-4">Registre sua bike</h1>
        <h2 class="my-4">
            Dados do comprador
        </h2>

        <input class="form-control my-2" type="nome" placeholder="Informe seu nome:">
        <input class="form-control my-2" type="email" placeholder="Seu email:">
        <input class="form-control my-2" type="telefone" placeholder="Telefone:">
        ...
        <div class="d-flex input-group align-items-center col-5 my-2 ">
            ...
            <input type="text" name="documento" class="form-control my-2">
        </div>
        <input class="form-control my-2" type="text" name="rua" placeholder="Rua:">
        <div class="my-2 row">
        ...
        <div class="my-2 row">
            <div class="col-md-2 my-2 mx-0">
                <input type="text" class="form-control" name="modelo_bike" placeholder="Modelo da Bike">
            </div>
            <div class="col-md-5 mx-0 my-2">
                <input type=" text" class="form-control" name="numero_serie" placeholder="Número de Série do Quadro">
            </div>
            <div class="col-md-5 mx-0 my-2">
                <input type=" text" class="form-control" name="nota_fiscal" placeholder="Número da Nota Fiscal">
            </div>
        </div>
        <div class="my-2 row">
            <div class="col-md my-2 mx-0">
                <input type="text" class="form-control" name="nome_revenda" placeholder="Nome da Revenda">
            </div>
            <div class="col-md my-2 mx-0">
        ...
        <textarea rows="8" class="form-control my-4" maxlength="2000" readonly>
        ...
        <div class="form-check my-4">
            <input class="form-check-input" type="radio" required id="exampleRadios1" value="option1">
